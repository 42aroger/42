...
echo' <div class="panel panel-warning">
			  ...
			  <video width="690" height="380" autoplay controls>
				<source src="'.$baseurl[$burl].''.$file.'" type="video/mp4">
...
echo' <div class="panel panel-warning">
			  ...
			  <object classid="clsid:67DABFBF-D0AB-41fa-9C46-CC0F21721616" width="690px" height="380px" codebase="http://go.divx.com/plugin/DivXBrowserPlugin.cab">
	            <param name="src" value="'.$baseurl[$burl].''.$file.'" />
	            <embed type="video/divx" src="'.$baseurl[$burl].''.$file.'"
...
echo' <div class="panel panel-warning">
			  ...
			  <center>
			  <video width="690" height="380" autoplay controls>
				<source src="'.$baseurl[$burl].''.$sfile.'" type="video/mp4">
				Your browser does not support the video tag.
				</video>
				</center>
				</div>
...
echo' <div class="panel panel-warning">
			  ...
			  <center>
			  <object classid="clsid:67DABFBF-D0AB-41fa-9C46-CC0F21721616" width="690px" height="380px" codebase="http://go.divx.com/plugin/DivXBrowserPlugin.cab">
	            <param name="src" value="'.$baseurl[$burl].''.$sfile.'" />
	            <embed type="video/divx" src="'.$baseurl[$burl].''.$sfile.'"
	                   width="640" height="360"
	                   pluginspage="http://go.divx.com/plugin/download/">
	            </embed>
				</object>

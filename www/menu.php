        ...
        <div class="navbar-collapse collapse" id="navbar-main">
          <ul class="nav navbar-nav">
					...
					?>
                      ...
                      <li <?php if ($cat == 2) { echo'class="active"'; } ?>><a href="search.php?cat=Series">Series</a></li>
					  <li <?php if ($cat == 3) { echo'class="active"'; } ?>><a href="search.php?cat=Doc">Doc</a></li>
					  <li <?php if ($cat == 4) { echo'class="active"'; } ?>><a href="search.php?cat=Anime">Anime</a></li>
					  <li <?php if ($cat == 5) { echo'class="active"'; } ?>><a href="search.php">Rechercher</a></li>
					  <li><?php if(empty($lastid)) { echo '<a href="#"><img src="img/refresh.png" width="18" height="18" /></a>'; } else { echo '<a href="reload.php"><img src="img/refresh.png" width="18" height="18" /></a>';} ?></li>
                    </ul>
                    <ul class="nav navbar-nav navbar-right">
						<form class="navbar-form navbar-left" action="search.php" method="post">
                    <input type="text" name="search" class="form-control col-lg-8" placeholder="Recherche rapide">
                    </form>
                      <li <?php if ($cat == 6) { echo'class="active"'; } ?>><a href="profile.php">Profile </a></li>
				  <?php //Administrateur
				  if($_SESSION['rank']==1) { 
				  $countreq=0;
				  ...
				  if ($cat == 8) { echo'<li class="active">'; } else { echo '<li>'; } echo'<a href="admin.php">Admin</a></li>'; 
				  }
